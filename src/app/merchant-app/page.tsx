            ...
            <main className="mx-auto max-w px-6 pb-20 pt-12">
                ...
                <section className="mx-auto grid w-full max-w-6xl gap-12 px-6 pb-14 pt-8 lg:grid-cols-2 lg:items-center">
                    ...
                    <div>
                        ...
                        <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate-600">
                            Sell faster, track commissions automatically, and
                            stay in control during peak rush. The takeaway
                            Merchant App is launching soon for iOS and Android.
                        </p>
                            ...
                            <div className="flex items-start justify-between gap-4">
                                <div>
                                    <p className="text-sm font-semibold text-slate-900">
                                        Built for Singapore-style merchant
                                        events
                                    </p>
                                    <p className="mt-1 text-sm text-slate-600">
                                        Smooth checkout • Live sales •
                ...
                <section className="mx-auto w-full max-w-6xl px-6 py-16">
                    <div className="grid gap-10 lg:grid-cols-3 lg:items-start">
                        <div className="lg:col-span-1 flex flex-col self-stretch justify-center">
                            <h2 className="text-3xl font-extrabold tracking-tight text-slate-900">
                                What merchants get
                            </h2>
                            <p className="mt-4 text-slate-600">
                                A lightweight app designed for high-volume sales
                                and clean settlement after the event.
                            </p>
                        </div>
                    ...
                    <div className="mt-10 rounded-[20px] bg-[#F3F5F7] p-6 ring-1 ring-black/5">
                        <p className="text-2xl font-bold text-[#2B55A0]">
                            Want to talk?
                        </p>
                        <p className="text-lg mt-2">
                            If you’re organizing an upcoming market, we’d love
                            to learn your workflow and pain points.
                        </p>
